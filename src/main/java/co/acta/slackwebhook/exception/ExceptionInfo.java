...
public enum ExceptionInfo {
    ...
    REPLY_NOT_FOUND(114, "답글 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    REPLY_BO_ID_NOT_FOUND(115, "[답변] - BO 댓글 PK가 없어 수정/삭제가 불가능합니다. BO 시스템의 댓글 등록 응답을 확인해주세요.", HttpStatus.INTERNAL_SERVER_ERROR);
