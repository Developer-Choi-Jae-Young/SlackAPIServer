...
public class ParamMappingBoardID extends UtilsModal implements SlackModalAPI {
    ...
    public Map<?, ?> makeModalFrame(DomainInfo domainInfo) {
        ...
        if(domainInfo != null && domainInfo.getParamMappingBoardId() != null && !domainInfo.getParamMappingBoardId().isEmpty()) element.put("initial_value", domainInfo.getParamMappingBoardId());
